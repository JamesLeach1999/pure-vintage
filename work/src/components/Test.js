      ...
      <div className="small-container row filter-container">
        <div className="row product">
          {this.state.data.map((products) => {
            return products
              .slice(this.state.page, this.state.page + 4)
              .map((product) => {
                // const image = <img alt="" src={require(`./assets/${n.image}`)}/>
                return (
                  <Link to={`/product/${product._id}`}>
        ...
        <div className="row product">
          {this.state.data.map((products) => {
            return products
              .slice(this.state.page + 4, this.state.page + 8)
              .map((product) => {
                // const image = <img alt="" src={require(`./assets/${n.image}`)}/>
                return (
                  <Link to={`/product/${product._id}`}>
        ...
        <div className="row product">
          {this.state.data.map((products) => {
            return products
              .slice(this.state.page + 8, this.state.page + 12)
              .map((product) => {
                // const image = <img alt="" src={require(`./assets/${n.image}`)}/>
                return (
                  <Link to={`/product/${product._id}`}>
        ...
        <div className="row product">
          {this.state.data.map((products) => {
            return products
              .slice(this.state.page + 12, this.state.page + 16)
              .map((product) => {
                // const image = <img alt="" src={require(`./assets/${n.image}`)}/>
                return (
                  <Link to={`/product/${product._id}`}>
